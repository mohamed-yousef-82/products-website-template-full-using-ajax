...
<body>
    ...
    <main>
      ...
      <div class="container">
        ...
        <div class="box box-1">
      <a class="logo link" data-page="main">
      ...
      <form class="search-form" method="post">
                        ...
                        <input type="text" id="search" name="search" placeholder="<?php echo lang('SEARCHTEXT') ?>">
                        <button type="button" class="start-btn blue search-button"><?php echo lang('SEARCH') ?></button>
      ...
      <div class="nav-container">
        ...
        <ul class="nav-left">
          <li>
            <a class="home link" data-page="main">
              <i class="fa fa-home">
              </i>
            </a>
          </li>
          <?php
            ...
            foreach ($categories as $cat) {
              ...
              echo "<li><a class='link' data-id='$cat[id]' data-page='categories'>";
              echo $cat['name'];
              echo "</a>";
              echo "<ul class='dropdown'>";
              $select = sql("SELECT * FROM categories WHERE parent = $cat[id] ORDER BY id","fetchAll");
              foreach ($select as $sub_cat) {
              $catname=str_replace("-","%20",$sub_cat["name"]);
              echo "<li><a class='link' data-id='$sub_cat[id]' data-page='categories'>";
              echo $sub_cat['name'];
              echo "</a></li>";
              }
              echo "</ul>";
            ...
            <?php
              $about_page = sql("SELECT * FROM about","fetch");
                ...
                echo "<li><a class='link' data-page='about'>";
      ...
      ?>
      <li><a class="link login-link" data-page='login'>Login</a></li>
      <li><a class="link" data-page='registration'>Registration</a></li>
          <?php
          }
              ?>
</ul>
