          ...
          <div id="section1">
            <div class="slide-show-container">
              ...
              <div class="slide-show">
                ...
                <?php echo "<a class='start-btn orangered link' data-id=$selectview[id] data-page='slideshow'>";?><?php echo lang('READMORE') ?><?php echo "</a>"; ?>
                <?php echo "</div>"; ?>
              ...
              <div class="container">
                      <?php
                        $about_page = sql("SELECT * FROM about","fetch");
                          ...
                          echo "<a class='link' data-page='about'>";
                ...
                <div class="items-slider-container">
                  <div class="items-slider-horizontal wow fadeInLeft">
                    ...
                    <div id="slide-image">
                      <ul>
                        <?php
                          $last_items = sql("SELECT * FROM items WHERE activity = 1 ORDER BY id LIMIT 10","fetchAll");
                          foreach ($last_items as $last) {
                            echo "<li><div>";
                            echo "<img src='$last[image]' />";
                            echo "<p><a style='color:#fff;' class='link' data-id=$last[id] data-page='items'>$last[name]</a></p>";
                            echo "</div></li>";
                          }
                          ?>
                      </ul>
           ...
           <div class="container">
            <div class="row row-medium">
              <div class="box box-1">
                ...
                <div class="accordion">
                  <?php
               $select = sql("SELECT * FROM accordion WHERE activity = 1 ORDER BY id LIMIT 4","fetchAll");
               ...
               <div class="item">
                 ...
                 <div class="content">
                   <ul>
                     ...
                     <a class='link' data-id=<?php echo $select_view['id'] ?> data-page='accordion'><?php echo lang('READMORE') ?></a>
                     </div>
                     </li>
                   </ul>
                 </div>
...
<a data-filter="<?php echo $select_view['id'] ?>"><?php echo $select_view['title'] ?></a>
      ...
      <div class="clients padding-vertical">
          <div class="container">
        <h3 class="section-title"><a class="link" data-page="clients">Clients</a>
        </h3>
        <span class="separate">
                       <span class="line"></span>
                       <span class="separate-circle"></span>
